...
**Problems:** When testing it, I had it running but the output file wouldn't open in Windows Media Player. It opened fine in GoldWave, though, so I saved it as an MP3 in the binaries zip so you can see (or rather, hear) what the output sounds like.
